...
class WrappedField extends AbstractField {
	 ...
	 * 
	 * @param AbstractField|null $field The field to wrap
	 * @param string $wrapperClasses Classes to use
	 */
	public function __construct(?AbstractField $field=null, string $wrapperClasses="") {
		$this->setField($field);
		$this->setWrapperClasses($wrapperClasses);
