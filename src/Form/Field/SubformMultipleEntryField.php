 ...
 * Use cases: type stages, payemnt options
 */
class SubformMultipleEntryField extends AbstractField {
	...
	public function getJsOnload() : string {
		...
		$str .= '$(document.getElementById('.json_encode($this->getId()).')).append(htmlToAdd);';
		...
		$str .= '$(document.getElementById('.json_encode($this->getId()).')).find(".raw-markdown").each(function() {renderMarkdownArea(this);});';
