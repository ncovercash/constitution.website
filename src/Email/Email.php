...
namespace WeTheFuture\Email;

use \WeTheFuture\{Color,Controller};
use \WeTheFuture\Page\Values;
 ...
 */
class Email {
	public const NO_REPLY_EMAIL = ["no-reply@constitution.website", "Noah Overcash's Entry No-Reply"];
	public const NO_REPLY_PASSWORD = Secrets::NO_REPLY_PASSWORD;

	// used for logging errors
	public const ERROR_LOG_EMAIL = ["error_logs@constitution.website", "constitution.website Error Logging"];
	public const ERROR_LOG_PASSWORD = Secrets::ERROR_LOG_PASSWORD;

	public const EMAIL_SMTP = ["constitution.website", 465, "ssl"];
	...
	public static function sendEmail(array $recipients, string $subject, string $message, string $textMessage, array $email, string $pass, array $smtp=self::EMAIL_SMTP) : bool {
		return true; // SOMETHING VERY BROKEN HERE IT USED TO WORK ??
		...
		$mail->addCustomHeader("List-Unsubscribe",'<mailto:smileytechguy@smileytechguy.com?subject=Unsubscribe>');
		...
		$message .= "<p>&copy;".date("Y")." Noah Overcash, All rights reserved.  Version: ".Controller::getVersion()." (".Controller::getCommit().").</p>";
		$message .= "<p>This e-mail is sent as part of Noah Overcash's entry into Constituting America's We the Future Contest.</p>";
		$message .= "<p>If you have any questions, comments, or concerns, do not hesitate to contact Noah Overcash at <a href=\"mailto:smileytechguy@smileytechguy.com\">smileytechguy@smileytechguy.com</a>.</p>";

		$textMessage .= "\r\n";
		$textMessage .= "--\r\n";
		$textMessage .= "(C) ".date("Y")." Noah Overcash, All rights reserved.  Version: ".Controller::getVersion()." (".Controller::getCommit().").\r\n";
		$textMessage .= "This e-mail is sent as part of Noah Overcash's entry into Constituting America's We the Future Contest.\r\n";
		$textMessage .= "If you have any questions, comments, or concerns, do not hesitate to contact Noah Overcash at smileytechguy@smileytechguy.com.\r\n";
