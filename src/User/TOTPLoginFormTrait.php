...
use \WeTheFuture\Form\Field\{AutocompleteValues,StaticHTMLField,TextField};
...
trait TOTPLoginFormTrait {
	...
	public static function getTotpLoginForm() : Form {
		...
		$noCodeMessage->setHtml('<p class="col s12 no-top-margin">If you do not have access to this code, please <a href="'.ROOTDIR.'About">contact us</a>.</p>');
