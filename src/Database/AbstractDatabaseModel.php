...
use \WeTheFuture\Database\Query\{SelectQuery, UpdateQuery};
use \WeTheFuture\Database\QueryAddition\WhereClause;
use \WeTheFuture\Images\{HasImageSetTrait, HasImageTrait};
...
abstract class AbstractDatabaseModel implements Serializable {
	...
	public function unserialize($data) : void {
		...
		self::$cache[static::class][$this->id] = array_merge(self::$cache[static::class][$this->id], $row === true ? [] : $row); // latter overwrites previous
